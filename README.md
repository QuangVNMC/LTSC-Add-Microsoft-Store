...
This script will install Microsoft Store and Xbox Identity Provider, you can download latest version [here](https://github.com/QuangVNMC/LTSC-Add-Microsoft-Store/releases/latest) (for both online and offline version)  
